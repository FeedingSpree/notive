...
const CachingScreen = ({ navigation }) => {
  const [tasks, setTasks] = useState([
    { id: '1', title: 'GEE quiz 5', dueDate: 'Due Today', color: '#DC3545', completed: false },
    { id: '2', title: 'CS 401 Assignment', dueDate: 'Due 02/14', color: '#0D6EFD', completed: false },
    { id: '3', title: 'IT 001 Project', dueDate: 'Due 03/23', color: '#198754', completed: false },
  ]);
