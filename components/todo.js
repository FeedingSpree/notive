...
const CachingScreen = ({ navigation }) => {
  const [tasks, setTasks] = useState([
    { id: '1', title: 'GEE quiz 5', color: '#DC3545', completed: false },
    { id: '2', title: 'CS 401 Assignment', color: '#0D6EFD', completed: false },
    { id: '3', title: 'IT 001 Project', color: '#198754', completed: false },
  ]);
